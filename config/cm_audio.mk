...
ALARM_PATH := vendor/epic/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/epic/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/epic/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/epic/prebuilt/common/media/audio/ui
